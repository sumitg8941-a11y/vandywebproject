  ...
  return (
    <>
      ...
      <nav className="hidden peer-checked:block md:hidden bg-white border-t border-gray-100 px-4 py-3 space-y-1">
        ...
        <Link href="/blog" className="block py-2 px-3 rounded-lg text-gray-700 font-semibold hover:bg-red-50 hover:text-red-600 transition">
          <i className="fa-solid fa-pen-nib mr-3"></i>Blog
        </Link>
